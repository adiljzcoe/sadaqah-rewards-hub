...
import { Building2, MapPin, Star, Crown, Coins } from 'lucide-react';

const localBusinesses = [
  { rank: 1, name: 'Birmingham Islamic Centre', location: 'Birmingham', coins: 15420, donations: 85 },
  { rank: 2, name: 'Halal Corner Restaurant', location: 'Manchester', coins: 12800, donations: 72 },
  { rank: 3, name: 'Al-Noor Grocery', location: 'London', coins: 11600, donations: 68 },
  { rank: 4, name: 'Mosque Community Shop', location: 'Leeds', coins: 9800, donations: 54 },
  { rank: 5, name: 'Islamic Bookstore', location: 'Bradford', coins: 8500, donations: 47 },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Local and national businesses supporting our community by purchasing{' '}
