...
const MobileSidebar = ({ userLevel, currentPoints, nextLevelPoints, isMember }: MobileSidebarProps) => {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent 
        side="right" 
        className="w-[320px] bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 backdrop-blur-xl border-l border-cyan-400/30 shadow-2xl text-white p-0 overflow-y-auto"
      >
        {/* User Profile Header */}
