  ...
  return (
    <>
      <style>{`
        ...
        @keyframes orange-fundraising-glow {
          0% {
            box-shadow: 0 0 8px rgba(249, 115, 22, 0.5), 0 0 16px rgba(249, 115, 22, 0.4), 0 0 24px rgba(249, 115, 22, 0.3);
          }
          50% {
            box-shadow: 0 0 12px rgba(249, 115, 22, 0.7), 0 0 24px rgba(249, 115, 22, 0.5), 0 0 36px rgba(249, 115, 22, 0.4), 0 0 48px rgba(249, 115, 22, 0.2);
          }
          100% {
            box-shadow: 0 0 8px rgba(249, 115, 22, 0.5), 0 0 16px rgba(249, 115, 22, 0.4), 0 0 24px rgba(249, 115, 22, 0.3);
          }
      ...
      <div className={`${isSticky ? 'fixed bottom-0' : 'relative'} left-0 right-0 z-50 transition-all duration-300 bg-white border-t border-gray-200 shadow-lg`}>
        <div className={`relative z-10 container mx-auto px-2 sm:px-4 transition-all duration-300 ${isSticky ? 'py-2' : 'py-3'}`}>
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <div className={`grid grid-cols-3 sm:grid-cols-8 gap-1 sm:gap-2 mb-2 sm:mb-3 transition-all duration-300 ${isSticky ? 'mb-2' : 'mb-3'}`}>
              {Object.entries(donationTypeStyles).map(([key, style]) => (
                ...
                >
                  <div className="flex flex-col sm:flex-row items-center justify-center space-y-0 sm:space-y-0 sm:space-x-1">
                    ...
                    <span className="font-medium capitalize text-[10px] sm:text-xs">{key === 'honoring' ? 'Honoring' : key === 'fundraising' ? 'Fundraising' : key}</span>
                  </div>
                </button>
              ))}
            </div>
