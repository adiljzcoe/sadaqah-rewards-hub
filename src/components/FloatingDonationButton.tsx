    ...
    <div className="fixed bottom-8 right-8 z-50">
      ...
      >
        ...
        {fallingCoins.map((coin) => (
          ...
          >
            <div 
              className="w-full h-full rounded-full bg-gradient-to-br from-yellow-300 via-yellow-400 to-amber-500 border border-yellow-200 shadow-sm animate-[fall-into-slot_2.5s_ease-in_forwards]"
              style={{
