    ...
    <div className="w-full max-w-full overflow-hidden">
      <div className="relative w-full aspect-video bg-gray-900 rounded-t-xl overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-4 left-4 bg-black/30 backdrop-blur-md rounded px-2 py-1 border border-white/20">
          ...
          <div className="absolute bottom-4 right-4 bg-black/30 backdrop-blur-md rounded px-2 py-1 text-white text-xs border border-white/20">
            HD 1080p
          </div>
        </div>

        {/* Epic Donation Notification - Much more transparent */}
        {epicNotification && (
          <div className="absolute inset-0 bg-gradient-to-r from-purple-900/20 to-pink-900/20 backdrop-blur-sm z-60 flex items-center justify-center animate-fade-in">
            <div className="text-center text-white bg-black/20 backdrop-blur-xl rounded-2xl p-8 border border-white/30">
        ...
        {/* Top overlay with stats - More transparent glass effect */}
        <div className="absolute top-0 left-0 right-0 p-4 z-10">
          <div className="flex justify-between items-start">
            <Badge className="bg-red-500/80 hover:bg-red-600 text-white shadow-lg px-3 py-2 animate-pulse backdrop-blur-xl border border-white/20">
              <div className="w-2 h-2 bg-white rounded-full mr-2 animate-ping"></div>
              LIVE
            </Badge>

            <div className="flex items-center space-x-3 bg-black/20 backdrop-blur-xl rounded-xl p-3 shadow-xl border border-white/30">
        ...
        <div className="absolute top-20 right-4 z-30">
          <Button className="bg-gradient-to-r from-amber-500/70 to-yellow-600/70 hover:from-amber-600/80 hover:to-yellow-700/80 text-white shadow-lg px-4 py-2 text-sm font-bold rounded-xl hover:scale-105 transition-all duration-300 relative overflow-hidden group backdrop-blur-xl border border-white/20">
        ...
        {/* Positive Affirmation - More transparent */}
        {showAffirmation && (
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 animate-bounce">
            <div className="bg-gradient-to-r from-pink-500/70 to-purple-600/70 text-white px-6 py-3 rounded-2xl text-lg font-bold shadow-xl border-2 border-white/50 backdrop-blur-xl">
              {currentAffirmation}
            </div>
          </div>
        )}

        {/* Recent donations feed - More transparent */}
        <div className="absolute left-4 top-32 space-y-2 z-20 max-w-sm">
          {[...recentDonations, ...fakeDonations].slice(0, 4).map((donation) => (
            <div
              key={donation.id}
              className="bg-gradient-to-r from-emerald-500/70 to-green-600/70 text-white px-3 py-2 rounded-2xl text-sm font-medium flex items-center space-x-2 animate-slide-in-left shadow-xl border-2 border-emerald-300/50 hover:scale-105 transition-transform max-w-full backdrop-blur-xl"
            >
        ...
        {/* Celebration overlay - More transparent */}
        {celebrationMode && (
        ...
        {floatingCoins.map((coin) => (
          ...
          >
            <div className="flex items-center space-x-1 bg-gradient-to-r from-yellow-400/80 to-amber-500/80 text-white px-3 py-1 rounded-full text-sm font-bold shadow-lg backdrop-blur-xl border border-white/30">
        ...
        {/* Donation buttons at bottom - Glossy glass effect */}
        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-60">
          <div className="flex justify-center items-center space-x-4 bg-gray-800/30 backdrop-blur-xl rounded-2xl p-3 shadow-2xl border border-gray-600/50">
              ...
              {quickDonations.map((donation, index) => (
                <button
                  ...
                  className={`
                    ...
                    transition-all duration-300 border-2 border-white/50 backdrop-blur-sm
      ...
      {/* Bottom controls section - Glossy glass effect */}
      <div className="bg-gradient-to-r from-gray-800/50 via-gray-700/50 to-gray-800/50 py-6 px-8 rounded-b-xl border-t border-gray-600/50 backdrop-blur-xl">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-6">
            ...
            <div className="text-sm text-emerald-400 flex items-center space-x-4 font-medium">
              <div className="flex items-center bg-emerald-500/20 px-3 py-1 rounded-lg border border-emerald-400/30 hover:scale-105 transition-transform cursor-pointer backdrop-blur-sm">
          ...
          <div className="flex items-center space-x-4">
            <Button variant="outline" size="sm" className="bg-gray-700/30 border-gray-500/50 text-white hover:bg-gray-600/50 hover:scale-105 transition-all px-4 py-2 hover:border-blue-400 backdrop-blur-sm">
              <Share2 className="h-4 w-4 mr-2" />
              Share & Earn 50 Sadaqah Coins
            </Button>
            
            <Button variant="outline" size="sm" className="bg-gray-700/30 border-gray-500/50 text-white hover:bg-gray-600/50 hover:scale-105 transition-all relative px-4 py-2 hover:border-pink-400 backdrop-blur-sm">
