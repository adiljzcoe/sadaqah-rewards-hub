      ...
      <section className="container mx-auto px-4 py-16 max-w-full overflow-x-hidden">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center p-8 professional-card rounded-xl hover-lift">
            ...
            <p className="text-gray-600">{t('gamified_description')}</p>
          </div>
          ...
          <div className="text-center p-8 professional-card rounded-xl hover-lift">
            ...
            <p className="text-gray-600">{t('league_description')}</p>
          </div>
          ...
          <div className="text-center p-8 professional-card rounded-xl hover-lift">
            ...
            <p className="text-gray-600">{t('live_impact_description')}</p>
          </div>
        </div>
